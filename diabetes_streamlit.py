...
# Load the scaler
with open(r'C:\Users\Mohammed Rafey\Desktop\New folder\diabetes_scaler.pkl', 'rb') as scaler_pickle:
    scaler = pickle.load(scaler_pickle)

# Load the KNN model
with open(r'C:\Users\Mohammed Rafey\Desktop\New folder\diabetes_KNN.pkl', 'rb') as knn_file:
...
if st.button("Predict"):
    ...
    knn_result = " Disease Detected" if knn_prediction[0] == 1 else "No Disease detected"
